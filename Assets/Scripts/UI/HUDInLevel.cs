...
namespace DiabloKiller {
    public class HUDInLevel : MonoBehaviour, HUDView  {
        ...
        public void TakeDamage(long damageTaken, long currentHealth) {
        ...
        public void ReceiveHealth(long healthReceived,  long currentHealth) {
            // Set the health bar's value to the current health.
            healthSlider.value = currentHealth;

        }

        public void AddMana(long manaAdded, long currentMana) {
            // Set the health bar's value to the current health.
            manaSlider.value = currentMana;

        }

        public void SpendMana(long manaSpent, long currentMana) {
            // Set the health bar's value to the current health.
            manaSlider.value = currentMana;
